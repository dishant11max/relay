  ...
  return (
    <>
      ...
      >
        ...
        <nav style={{ flex: 1 }}>
          {NAV_ITEMS.map((item) => (
            <NavButton key={item.section} item={item} />
          ))}
        </nav>
          ...
          return (
            <button
              ...
              style={{
                ...
                background: 'transparent',
                border: 'none',
                borderTop: isActive ? '2px solid #4afe80' : '2px solid transparent',
                cursor: 'pointer',
                transition: 'all 150ms',
              }}
            >
              <span style={{ fontSize: 14, color: isActive ? '#4afe80' : '#3a3a3a' }}>
                {item.icon}
              </span>
              <span
                className="font-mono font-bold"
